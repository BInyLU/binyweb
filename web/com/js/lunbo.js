	...
	e.prototype = {
		_init: function () {
			...
			b.$element.find(".pogoSlider-slide").each(function () {
				...
				b._createProgessBar(), b.$element.css("padding-bottom", 100 / (b.settings.targetWidth / b.settings.targetHeight) +
					"%");
		...
		_createDirButtons: function () {
			...
			b.$element.addClass("pogoSlider--dir" + b.settings.buttonPosition), a(
				'<button class="pogoSlider-dir-btn pogoSlider-dir-btn--prev"></button>').appendTo(b.$element).on("click",
				function () {
					b.prevSlide()
