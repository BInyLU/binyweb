...
window['_mstConfig'] = {
	appId: 'YaXopmDNCSIQMEbRyKO9LTD1SbF8Lfu64pnuBJEef_SDPY3e9okf2eFW0vtmQPaQHZHSArZHdf9zRzM30J0iS_IUedOH2vzUvSpfz18pnBjBfmbfRw4O-pMaP4WyIgv9X',
...
window._mstConfig['SignIn'] =
	'<a href="https://login.live.com/login.srf?wa=wsignin1.0&amp;rpsnv=13&amp;ct=1538297008&amp;rver=6.7.6636.0&amp;wp=LBI&amp;wreply=http:%2F%2Fwww.microsofttranslator.com%2Fajax%2Fv2%2Fauth.aspx%3Fpru%3Dhttps%253a%252f%252fblog.csdn.net%252fweixin_40687883%252farticle%252fdetails%252f81451385&amp;lc=2052&amp;id=268160">登录</a>';
...
Microsoft.Translator = new function() {
	...
	var h = new function() {
		...
		var J = b.getnoneParent = function(a) {
	...
	function mc(Fb, nb, qb, ob, db, Gc, Cc, P, J, Lc) {
		...
		function uc(a, b, d) {
			...
			try {
				if (k.sourceFrame) {
					k[d] = a;
					new kc(a, b, h.getnoneParent(a), xb(O), k, H)
				} else {
					k[d] = b;
					new kc(b, a, h.getnoneParent(b), xb(L || k.detectedLanguage), k, H)
				}
			} catch (j) {}
			k.transItems.push({
				src: a,
...
MtPopUpList.prototype = {
	...
	Show: function(c, b) {
		...
		if (b) {
			...
			a.HideCurrentPopup();
			b.cancelBubble = d;
			if (a.ChangeObjectDisplay(c, "none")) {
...
window['_mstConfig'].floaterStylePath =
	'http://www.microsofttranslator.com/static/25632543/css/WidgetV3.css?v=25632543';
...
function onloadCallback() {
	...
	try {
		...
		appendHTMLToBody(decodeURIComponent('xx'));
		appendHTMLToBody(decodeURIComponent('xx'));
		var code = '';
